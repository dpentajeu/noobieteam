        ...
        return (
            <div className="jukebox-floating jukebox-maximized bg-white p-6 rounded-[2rem] shadow-2xl border border-gray-100 animate-pop text-black">
                <div className="flex justify-between items-center mb-4">
                    <h4 className="text-[8px] font-black uppercase tracking-[0.2em] text-gray-400">{t('labels.project_audio')}</h4>
                ...
                <div className="flex gap-2">
                    <input className="flex-1 p-3 bg-gray-50 rounded-xl text-[10px] border border-gray-100 outline-none focus:ring-1 focus:ring-black text-black" placeholder={t('labels.youtube_url') || "YouTube URL..."} value={input} onChange={e => setInput(e.target.value)} />
    ...
    return (
        <div className="jukebox-floating jukebox-maximized bg-black overflow-hidden flex flex-col animate-pop">
            <div className="p-3 flex justify-between items-center bg-gray-900/90 text-white">
                <span className="text-[8px] font-black uppercase tracking-[0.2em] opacity-50">{t('labels.audio_streaming')}</span>
